    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index2.html" class="logo">
                ...
                <span class="logo-lg"><b>E-commerce</b>SITE</span>
            </a>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        ...
                                        <a class="profile_edit btn btn-success btn-flat"  data-id="#" data-toggle="modal"><i class="fa fa-fw fa-edit"></i><strong>Profile Update</strong></a>
                                    </div>
