		...
		<div class="home">
			...
			<div class="home_slider_container">
				<div class="owl-carousel owl-theme home_slider">
					...
					<!-- Slide -->
					<div class="owl-item">
						<div class="background_image" style="background-image:url(assets/client/images/home.jpg)"></div>
											...
											<div class="home_items">
												<div class="row">
													<div class="col-sm-3 offset-lg-1">
														<div class="home_item_side"><a href="product.html"><img src="assets/client/images/home_1.jpg" alt=""></a></div>
													</div>
																...
																<div class="product_buttons">
																	<div class="text-right d-flex flex-row align-items-start justify-content-start">
																		<div class="product_button product_fav text-center d-flex flex-column align-items-center justify-content-center">
																			<div><div><img src="assets/client/images/heart.svg" alt=""><div>+</div></div></div>
																		</div>
																		<div class="product_button product_cart text-center d-flex flex-column align-items-center justify-content-center">
																			<div><div><img src="assets/client/images/cart_2.svg" alt=""><div>+</div></div></div>
																		</div>
																	</div>
																</div>
															</div>
													...
													<div class="col-sm-3">
														<div class="home_item_side"><a href="product.html"><img src="assets/client/images/home_3.jpg" alt=""></a></div>
													</div>
												</div>
											</div>
										</div>
				...
				<div class="row">
					<div class="col">
						<div class="boxes_container d-flex flex-row align-items-start justify-content-between flex-wrap">
							...
							<!-- Box -->
							<div class="box">
								<div class="background_image" style="background-image:url(assets/client/images/box_1.jpg)"></div>
								<div class="box_content d-flex flex-row align-items-center justify-content-start">
									<div class="box_left">
										<div class="box_image">
											<a href="category.php">
												<div class="background_image" style="background-image:url(assets/client/images/box_1_img.jpg)"></div>
											</a>
										</div>
									</div>
							...
							<!-- Box -->
							<div class="box">
								<div class="background_image" style="background-image:url(assets/client/images/box_2.jpg)"></div>
								<div class="box_content d-flex flex-row align-items-center justify-content-start">
									<div class="box_left">
										<div class="box_image">
											<a href="category.php">
												<div class="background_image" style="background-image:url(assets/client/images/box_2_img.jpg)"></div>
											</a>
										</div>
									</div>
									<div class="box_right text-center">
							...
							<!-- Box -->
							<div class="box">
								<div class="background_image" style="background-image:url(assets/client/images/box_3.jpg)"></div>
								<div class="box_content d-flex flex-row align-items-center justify-content-start">
									<div class="box_left">
										<div class="box_image">
											<a href="category.php">
												<div class="background_image" style="background-image:url(assets/client/images/box_3_img.jpg)"></div>
											</a>
										</div>
									</div>
									<div class="box_right text-center">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-4 feature_col">
						<div class="feature d-flex flex-row align-items-start justify-content-start">
							<div class="feature_left">
								<div class="feature_icon"><img src="assets/client/images/icon_1.svg" alt=""></div>
							</div>
					...
					<div class="col-lg-4 feature_col">
						<div class="feature d-flex flex-row align-items-start justify-content-start">
							<div class="feature_left">
								<div class="feature_icon ml-auto mr-auto"><img src="assets/client/images/icon_2.svg" alt=""></div>
							</div>
							<div class="feature_right d-flex flex-column align-items-start justify-content-center">
					...
					<div class="col-lg-4 feature_col">
						<div class="feature d-flex flex-row align-items-start justify-content-start">
							<div class="feature_left">
								<div class="feature_icon"><img src="assets/client/images/icon_3.svg" alt=""></div>
							</div>
							<div class="feature_right d-flex flex-column align-items-start justify-content-center">
