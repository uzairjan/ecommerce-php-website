	...
	<header class="header">
		...
		<div class="header_content d-flex flex-row align-items-center justify-content-start">
			...
			<div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
				...
				<!-- Cart -->
				<div class="cart"><a href="cart.html"><div><img src="assets/client/images/cart.svg" alt="https://www.flaticon.com/authors/freepik"></div></a></div>
				<!-- Phone -->
						...
						<div class="col-lg-4 footer_col">
							<div class="footer_about">
								<div class="footer_logo">
									<a href="#">
										<div class="d-flex flex-row align-items-center justify-content-start">
											<div class="footer_logo_icon"><img src="assets/client/images/logo_2.png" alt=""></div>
											<div>Little Closet</div>
										</div>
									</a>		
								</div>
...
<script src="assets/client/styles/bootstrap-4.1.2/popper.js"></script>
<script src="assets/client/styles/bootstrap-4.1.2/bootstrap.min.js"></script>
...
<script src="assets/client/js/checkout.js"></script>
</body>
</html>